...
public class selectFlught {
	
	@FindBy(css="body > div > table > tbody > tr > td:nth-child(2) > table > tbody > tr:nth-child(4) > td > table > tbody > tr > td:nth-child(2) > table > tbody > tr:nth-child(5) > td > form > table:nth-child(9) > tbody > tr:nth-child(9) > td.frame_action_xrows > input[type=\"radio\"]")
	...
	public selectFlught(WebDriver driver) {
